        ...
        <div className={"boolean-choice"}>
            ...
            <div className="boolean-choice-body">
                <div
                    ...
                    <i className={props.trueIcon + " mr-2 " + ((booleanState === trueValue) ? "color-gradiant-green" : "color-gradiant-black")}/>
                    {props.trueText}
                </div>
                <div
                    ...
                    <i className={props.falseIcon + " mr-2 " + ((booleanState === falseValue) ? "color-gradiant-green" : "color-gradiant-black")}/>
                    {props.falseText}
                </div>
            </div>
        </div>
